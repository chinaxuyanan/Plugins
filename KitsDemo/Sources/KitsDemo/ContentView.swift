...
///
/// - SwiftUIProKit 组件：轮播图 / 倒计时 / 引导页 / 文本增强 / 热力图 / 瀑布流 / 日历选择器 / 标签输入 / 饼图
/// - LogKit 日志：采样 / 导出 / 崩溃兜底 / 反解析 / 链路聚合 / 合并日志 / 格式模板 / Markdown 报告
/// - SystemInfoKit 系统：网络流量 / 磁盘读写 / 内存明细 / 每核 CPU / 电池温度与电源 / 已安装应用
struct ContentView: View {
    ...
    private var header: some View {
        VStack(spacing: 4) {
            ...
            Text("复合组件 / 瀑布流 / 日历 / 标签 / 饼图 · 链路聚合与 Markdown 报告 · 内存明细 / 每核 CPU / 已安装应用")
                .font(.subheadline)
